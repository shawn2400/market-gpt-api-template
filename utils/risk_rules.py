...
RR_MIN_LOW_VOL         = float(os.getenv("RR_MIN_LOW_VOL",  "1.10"))  # 🎯 Adaptive: Low volatility = tighter RR
RR_MIN_MID_VOL         = float(os.getenv("RR_MIN_MID_VOL",  "1.15"))  # 🎯 Adaptive: Mid volatility = medium RR
RR_MIN_HIGH_VOL        = float(os.getenv("RR_MIN_HIGH_VOL", "1.25"))  # 🎯 Adaptive: High volatility = higher RR for safety
