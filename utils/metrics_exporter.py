...
api_requests_total = Counter(
    "algogpt_api_requests_total", "סה\"כ בקשות API לפי נתיב", ["path", "method", "status"]
)
api_latency_seconds = Histogram(
    "algogpt_api_latency_seconds", "לטנסי API לפי נתיב", ["path"], buckets=(0.01, 0.05, 0.1, 0.25, 0.5, 1, 2, 5)
)
