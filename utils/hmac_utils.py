...
# ===== Circuit Breaker =====
CB_WINDOW_SEC = int(os.getenv("CB_WINDOW_SEC", "30"))           # חלון זמן למדידת כשלים
CB_FAIL_THRESHOLD = int(os.getenv("CB_FAIL_THRESHOLD", "6"))    # מספר כשלים לפתיחה
CB_OPEN_SEC = int(os.getenv("CB_OPEN_SEC", "20"))               # השהייה כשפתוח
