...
"""
Shim module for backward-compat:
routes/ui_grid (ואחרים) מצפים ל- utils.trade_storage.
כאן אנחנו רק מייצאים הלאה את אותן פונקציות מ- utils.storage,
כדי שלא תצטרך לשכפל קוד.
"""

from typing import Any, Dict, List, Optional

try:
    # עדיף להשתמש במודול האוניברסלי שלך אם קיים
    from .storage import (
        save_json, load_json, put_json, get_json,
        save_payload, load_trades, cleanup_static,
    )
except Exception:
    # fallback מינימלי אם utils/storage.py לא זמין משום־מה
    import os, json, uuid
