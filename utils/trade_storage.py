...
# קובץ ברירת מחדל לאחסון הטריידים הפתוחים (ניתן לשנות באמצעות משתנה סביבה TRADES_FILE)
TRADES_FILE = os.getenv("TRADES_FILE", "open_trades.json")

def load_open_trades() -> List[Dict]:
    """טוען את כל הטריידים הפתוחים מהקובץ."""
...
def get_open_trades_count() -> int:
    """מחזיר את מספר הטריידים הפתוחים."""
    return len(load_open_trades())

def save_trade(trade: Dict) -> None:
    """שומר טרייד חדש לרשימת הטריידים הפתוחים."""
