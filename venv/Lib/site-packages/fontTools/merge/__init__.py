...
timer = Timer(logger=logging.getLogger(__name__ + ".timer"), level=os.getenv("LOG_LEVEL","WARNING").upper())
...
def main(args=None):
    ...
    configLogger(level=os.getenv("LOG_LEVEL","WARNING").upper() if options.verbose else logging.WARNING)
    if options.timing:
